# bdjang.github.io
This personal portfolio website is hosted on GitHub Pages and built with Vite and React 18. An Express.js server deployed on Heroku fetches art feed JSON data from a MongoDB cluster and serves it via RESTful APIs in the Footer component.
